	...
	<div id="wpmi-admin-rating" class="wpmi-notice notice notice-info is-dismissible" data-notice_id="wpmi-user-rating">
		<div class="notice-container" style="padding-top: 10px; padding-bottom: 10px; display: flex; justify-content: left; align-items: center;">
			...
			<div class="notice-content" style="margin-left: 15px;">
				<p>
<b>
<?php printf( esc_html__( 'Post Template Select plugin found and active!', 'blue-haze' ), 'Blue Haze' ); ?>
</b><br>
<?php printf( esc_html__( 'Plugin conflicts with theme functionality and has been deactivated, refreshing in 5 seconds...', 'blue-haze' ), 'Blue Haze' ); ?>
	...
	<div id="wpmi-admin-rating" class="wpmi-notice notice notice-info is-dismissible" data-notice_id="wpmi-user-rating">
		<div class="notice-container" style="padding-top: 10px; padding-bottom: 10px; display: flex; justify-content: left; align-items: center;">
			...
			<div class="notice-content" style="margin-left: 15px;">
				<p>
<?php
	esc_html_e( 'Post Template Select plugin deactivated but still installed - Plugin duplicates theme functionality and should be removed.', 'blue-haze' );
	echo '<hr>';
if( is_multisite() ) {
    switch_to_blog(1);
?>
...
<?php
	...
	esc_html_e( 'Go to Plugins', 'blue-haze' );
	echo '
	</a>
	</p>
	</div>
