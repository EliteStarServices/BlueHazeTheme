 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Blue Haze
...
function blue_haze_register_required_plugins()
{
	...
	$plugins = array(
		...
		array(
			...
			'source'             => get_template_directory() . '/inc/tgm-plugin/plugins/tgm-example-plugin.zip', // The plugin source.
	...
	*/
	 ...
	 */
	$config = array(
		'id'           => 'blue-haze',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'blue-haze' ),
			'menu_title'                      => __( 'Install Plugins', 'blue-haze' ),
			/* translators: %s: plugin name. * /
			'installing'                      => __( 'Installing Plugin: %s', 'blue-haze' ),
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', 'blue-haze' ),
			'oops'                            => __( 'Something went wrong with the plugin API.', 'blue-haze' ),
			...
			'return'                          => __( 'Return to Required Plugins Installer', 'blue-haze' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'blue-haze' ),
			'activated_successfully'          => __( 'The following plugin was activated successfully:', 'blue-haze' ),
			/* translators: 1: plugin name. * /
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'blue-haze' ),
			/* translators: 1: plugin name. * /
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'blue-haze' ),
			/* translators: 1: dashboard link. * /
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'blue-haze' ),
			'dismiss'                         => __( 'Dismiss this notice', 'blue-haze' ),
			'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', 'blue-haze' ),
			'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'blue-haze' ),
