...
<section class="no-results not-found">
	...
	<div class="page-content row-with-vspace">
		...
		<?php } elseif (is_search()) { ?> 
			<p><?php _e('Nothing matched your search terms. Please try again with different keywords.', 'bootstrap-basic'); ?></p>
			<?php echo bootstrapBasicFullPageSearchForm(); ?> 
		<?php } else { ?> 
			<p><?php _e('We can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'bootstrap-basic'); ?></p>
			<?php echo bootstrapBasicFullPageSearchForm(); ?> 
		<?php } //endif; ?> 
	</div><!-- .page-content -->
</section><!-- .no-results -->